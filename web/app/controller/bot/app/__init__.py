from .settings import DATABASE_URL, manifest_json, background_js
...
async def createDatabase() -> None:
    ...
    async with connection.begin() as _connection:
        from .models import Cart, CreditCard, Item, Login, Logout, Operation, OpenDrop, UpcomingDrop, User
